...
hi CursorLineNr     guifg=#992525               ctermfg=124               gui=bold cterm=bold
...
hi Search           guifg=#c4c4c4 guibg=#992525 ctermfg=NONE ctermbg=124
hi Sneak            guifg=#c4c4c4 guibg=#992525 ctermfg=NONE ctermbg=124

hi FoldColumn       guifg=#2d3638 guibg=#101112              ctermbg=233
hi Folded           guifg=#992525 guibg=#101112 ctermfg=124  ctermbg=233

hi Boolean          guifg=#e5ab57               ctermfg=11
hi Number           guifg=#e5ab57               ctermfg=11
hi Character        guifg=#707880
hi String           guifg=#707880
hi Conditional      guifg=#992525               ctermfg=124               gui=bold cterm=bold
hi Include          guifg=#992525
hi Comment          guifg=#465457
hi Statement        guifg=#992525               ctermfg=124               gui=bold cterm=bold
hi Label            guifg=#d27049
hi Access           guifg=#d27049                                         gui=bold cterm=bold
hi cppAccess        guifg=#d27049                                         gui=bold cterm=bold
hi Type             guifg=#992525               ctermfg=124               gui=bold cterm=bold
...
hi MatchParen       guifg=#992525 guibg=#151517 ctermfg=124               gui=bold cterm=bold
...
" err
hi Error            guifg=#992525 guibg=#19191c ctermfg=124               gui=bold cterm=bold
hi ErrorMsg         guifg=#992525 guibg=#151517 ctermfg=124               gui=bold cterm=bold
hi WarningMsg       guifg=#992525 guibg=NONE    ctermfg=124               gui=bold cterm=bold
...
hi markdownLinkText        guifg=#992525 ctermfg=124
hi markdownCode            guifg=#c4c4c4 ctermfg=NONE
hi markdownCodeBlock       guifg=#c4c4c4 ctermfg=NONE

" completion menu
hi Pmenu            guifg=NONE    guibg=#202228
hi PmenuSel         guifg=NONE    guibg=#992525              ctermbg=124 gui=bold cterm=bold
hi PmenuSBar                      guibg=#19191c
hi PmenuThumb                     guibg=#992525              ctermbg=124
hi WildMenu         guifg=NONE    guibg=#992525              ctermbg=124 gui=bold cterm=bold
hi StatusLine       guifg=#101112 guibg=#c4c4c4 ctermfg=233
hi StatusLineNC     guifg=#101112 guibg=#c4c4c4 ctermfg=233

" spellcheck
if has("spell")
    hi SpellBad     guifg=#992525 guibg=NONE ctermfg=124 gui=underline cterm=underline
endif
